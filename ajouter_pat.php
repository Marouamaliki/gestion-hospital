...
if(isset($_POST['submit'])){// condition verification de submit des infos du dormulaire html
    ...
    $numero_doss_medical=$_POST['num_dossier_medicale'];
    ...
    $stmt_user=$conn->prepare("INSERT INTO `users`( `username`, `type`, `prenom`, `pasword`) VALUES(?,'patient',?,?)");
    ...
    $stmt_std=$conn->prepare("INSERT INTO `patient`(`user_id`, `nom`, `prenom`, `email`, `numero_telephone`, `num_dossier_medicale`, `date_naissance`, `sexe`) VALUES (?,?,?,?,?,?,?,?)");
    //liaison des parametre
    $stmt_std->bind_param("isssssss", $user_id, $nom, $prenom, $email, $numero_telephone, $numero_doss_medical, $date_naissance, $sexe);
    //execution de la requete    
    $stmt_std->execute();
...
<div class="navbar">
    ...
    <div>
        <!--Formulaire html pour ajouter des etd-->
         ...
         <p>Entrer les informations du patient</p>
         <form method="POST">
             ...
             <label for="num_dossier_medicale">Numero du dossier medicale:</label>
             <input class="p" type="text" name="num_dossier_medicale" required><br>
             <label for="date_naissance">Date de Naissance:</label>
             <input class="p" type="text" name="date_naissance" required><br>
             <label for="sexe">Sexe:</label>
             <input class="p" type="text" name="sexe" required ><br>
    ...
    <div>
    <a class="a1" style="color:#0e5add"  href="gestion_pat_admi.php">Retourner</a>
</nav>
    </div>
</body>
</html>