...
$numero_dossier_medicale = $row['num_dossier_medicale'];
...
if (isset($_POST["update"])) {//collect les données 
    ...
    $sql = "UPDATE `patient` SET 
        ...
        num_dossier_medicale='$numero_dossier_medicale',
        sexe='$sexe'
        WHERE id=$id";
...
<nav class="navbar navbar-expand-lg navbar-info bg-info" style="background-color: #0e5add !important;">
    ...
    <form action="" method="POST">
        ...
        ?>> <br>
        <label for="num_dossier_medicale">N°dossier medicale:</label>
        <input class="p" type="text" name="num_dossier_medicale" required  value=<?php 
         echo $numero_dossier_medicale;
        ?>> <br>
        <label for="sexe">Sexe:</label>
        <input class="p" type="text" name="sexe"  value=<?php 
         echo $sexe;
        ?>> <br>
