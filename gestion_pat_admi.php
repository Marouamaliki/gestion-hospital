                        ...
                        <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <a href="supprimer_pat.php">
                                        <h5 class="text-white">Supprimer/Modifier</h5>
                                        <h5 class="text-white">Patients</h5></a>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="col-md-3 bg-warning mx-2 mx-2" style="height: 130px;">
                        <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-9">
                                        <h5 class="my-2 text-white" styles="front-size:30px;">
                                        ...
                                        <a href="rendez_vous_pat.php">
                                        <h5 class="text-white">Rendez-vous</h5>
                                        <h5 class="text-white">Patient</h5></a>
                                    </div>
                                    <div class="col-md-3">
                                     <a hef="#"><i class="fa-solid fa-plus fa-3x my-4 "></i></a></i>
                                    </div>
                                </div>

                            </div>
                        </div>
                        <div class="col-md-3 bg-success mx-2 mx-2" style="height: 130px;">
                        <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-9">
                                        <h5 class="my-2 text-white" styles="front-size:30px;">
                                        ...
                                        <a href="dossier_medical_admi.php">
                                        <h5 class="text-white">Dossier medicale</h5>
                                        <h5 class="text-white">Patient</h5></a>
                                    </div>
                                    <div class="col-md-3">
                                     <a hef="#"><i class="fa-solid fa-plus fa-3x my-4 "></i></a></i>
