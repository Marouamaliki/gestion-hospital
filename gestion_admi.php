                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <a href="afficher_admi.php">
                                        <h5 class="text-white">Afficher</h5>
                                        <h5 class="text-white">Administrateur</h5>
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                     <a hef="afficher_admi.php"> <i class="fa-solid fa-user-tie fa-3x my-4"></i></a> 
                        ...
                        <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <a href="supprimer_admi.php">
                                        <h5 class="text-white">Supprimer/Modifier</h5>
                                        <h5 class="text-white">Administrateur</h5></a>
                                    </div>
                                    <div class="col-md-3">
